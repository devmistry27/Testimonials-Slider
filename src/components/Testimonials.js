...
const Testimonials = (props) => {
    ...
    return (
        <div className='w-[85vw] md:w-[700px] bg-white flex flex-col justify-center items-center mt-10 p-10 rounded-md transition-all duration-700 shadow-md hover:shadow-xl'>
            ...
            <div className='flex text-3xl mt-5 gap-3 text-violet-400 text-bold'>
            ...
            <div>
                <button className='mt-5 bg-violet-400 hover:bg-violet-500 transition-all duration-200 cursor-pointer px-10 py-2 rounded-md font-bold text-white text-lg shadow-md hover:shadow' onClick={surpriseHandler}>
                    Surprise Me
                </button>
            </div>
        </div>
